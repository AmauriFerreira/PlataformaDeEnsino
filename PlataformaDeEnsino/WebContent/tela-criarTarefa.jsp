...
<div class="page-header">
   ...
   <ul class="dropdown-menu">
     <li><a href="#">Aula</a></li>
     <li><a href="tela-updateTarefa.jsp">Tarefa</a></li>
 ...
 <form action="criarTarefa">  
  ...
  <div class="form-group">
                   <label for="inputTemaTarefa" class="col-sm-1 control-label">Título:</label>
                     <div class="col-sm-8">
                        <input type="text" name="temaTarefa" id="inputTemaTarefa" class="form-control" >
                     </div>
                     <label for="inputAvaliacaoTarefa" class="col-sm-1 control-label">Valor:</label>
                     <div class="col-sm-2">
                        <input type="text" name="avaliacaoTarefa" id="inputAvaliacaoTarefa" class="form-control">
                     </div>
 ...
 <br>
       ...
       <div class="row">
          ...
          <div class="form-group">
             ...
             <label for="inputConteudoTarefa" class="col-sm-1 control-label">Conteúdo:</label>
              <div class="col-sm-11">
            <textarea name="conteudoTarefa" id="inputConteudoTarefa"class="form-control"  rows="10" cols="12" required>
       ...
       <div class="row">
          ...
          <div class="form-group">
             ...
             <label for="inputObjetivoTarefa" class="col-sm-1 control-label">Objetivo:</label>
              <div class="col-sm-11">
            <textarea name="objetivoTarefa" id="inputObjetivoTarefa" class="form-control"  rows="10" cols="12" required>
 ...
 <div class="row">
      ...
      <div class="form-group">
                ...
                <label for="inputDtInicioTarefa" class="col-sm-1 control-label">Data Início:</label>
                    <div class="col-sm-5">
                   <input type="date" name="dtInicioTarefa" id="inputDtInicioTarefa">
                 </div>
  

                <label for="inputDtTerminoTarefa" class="col-sm-1 control-label">Data Término:</label>
                   <div class="col-sm-5">
                   <input type="date" name="dtTerminoTarefa" id="inputDtTerminoTarefa" >
                 </div>
  ...
  <br>
      ...
      <div class="form-group">
                ...
                <label for="inputMaterialTarefa" class="col-sm-1 control-label">Arquivo da Tarefa:</label>
                   <div class="col-sm-11">
                     <input type="file" name="materialTarefa" id="inputMaterialTarefa" >
                    </div>
                  </div>
           </div> <!-- fim da row -->
  ...
  <div class="row">
     ...
     <div class="text-center">
       ...
       <a  href= "tela-updateTarefa.jsp" class="btn btn-primary" target="_self">Editar</a>  
       </form>  
             <input type="hidden" name="acao" value="Tarefa">		
<button  type="submit"   value="CriarAula"  class="btn btn-primary" onclick="funcao1()">Criar</button>
  ...
  <br>
    ...
    <script src="javascript/tela-criarTarefa.js"></script>
  </body>
</html>
