...
<input type="submit" onclick="funcao1()"  value="Adcionar Aula"  name="ChamarCriarAula" formaction="ChamarCriarAula"/>	
...
<div class="form-group">
                ...
                <label for="inputMaterialAula" class="col-sm-1 control-label">Material:</label>
                   <div class="col-sm-5">
                     <input type="file" name="materialAula" value=${aula.materialAula}  id="inputMaterialAula" >
                    </div>
                    
                      <label for="inputVideoAula" class="col-sm-1 control-label">Vídeo:</label>
                   <div class="col-sm-5">
                     <input type="file" name="videoAula"  value=${aula.videoAula}  id="inputVideoAula" >
                    </div>
